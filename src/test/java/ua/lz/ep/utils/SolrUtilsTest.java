...
class SolrUtilsTest {
    ...
    @Test
    void createCorrectRequestShouldCombineDocumentIdsAndFullTimeRange() {
        ...
        SolrQuery query = SolrUtils.createCorrectRequest(periodRequest);
    ...
    @Test
    void createCorrectRequestShouldUseOpenEndedPeriodWhenOnlyStartIsProvided() {
        PeriodRequest periodRequest = new PeriodRequest();
        periodRequest.setStartPeriod(LocalDateTime.of(2026, 1, 9, 0, 0, 0, 365_000_000));
    ...
    @Test
    void createCorrectRequestShouldUseOpenEndedPeriodWhenOnlyEndIsProvided() {
        PeriodRequest periodRequest = new PeriodRequest();
        periodRequest.setEndPeriod(LocalDateTime.of(2026, 7, 9, 23, 59, 0));
    ...
    @Test
    void createCorrectRequestShouldUseDocumentIdsWhenPeriodIsMissing() {
        PeriodRequest periodRequest = new PeriodRequest();
        periodRequest.setDocumentIds(java.util.List.of("doc-1", " ", "doc-2"));
    ...
    @Test
    void createCorrectRequestShouldFallbackToMatchAllWhenNoFiltersAreProvided() {
        PeriodRequest periodRequest = new PeriodRequest();
    ...
    @Test
    void createCorrectRequestShouldRejectReversedPeriod() {
        PeriodRequest periodRequest = new PeriodRequest();
        ...
        assertThatThrownBy(() -> SolrUtils.createCorrectRequest(periodRequest))
